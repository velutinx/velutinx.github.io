...
const translations = {
  ...
  commissions: {
    en: { comTitle: "COMMISSIONS", comInfo: "Commission information will be added here soon.", comList: `✦ Prices<br>✦ Examples<br>✦ Terms of Service<br>✦ Queue Status<br><br>(Placeholder content — coming soon ♡)` },
    ja: { comTitle: "コミッション", comInfo: "コミッション情報は近日中に追加されます。", comList: `✦ 料金<br>✦ サンプル<br>✦ 利用規約<br>✦ 受付状況<br><br>（プレースホルダー — 近日公開 ♡）` },
    zh: { comTitle: "委托", comInfo: "委托信息即将添加在此。", comList: `✦ 价格<br>✦ 示例<br>✦ 服务条款<br>✦ 队列状态<br><br>（占位内容 — 即将推出 ♡）` },
    es: { comTitle: "COMISIONES", comInfo: "La información de comisiones se agregará aquí pronto.", comList: `✦ Precios<br>✦ Ejemplos<br>✦ Términos de Servicio<br>✦ Estado de la Cola<br><br>(Contenido provisional — próximamente ♡)` }
  },
  artwork: {
  ...
  contact: {
    en: { contactTitle: "CONTACT", contactDesc: "Use this form if you'd like to contact me via email!", labelName: "NAME", labelEmail: "EMAIL", labelMessage: "MESSAGE", namePlaceholder: "Name", emailPlaceholder: "Email", messagePlaceholder: "Message", sendBtn: "SEND", errorText: "Please fill out all fields correctly ♡", successText: "Message sent successfully! You will hear back soon! ♡♡" },
    ja: { contactTitle: "お問い合わせ", contactDesc: "メールで連絡したい場合はこちらのフォームをご利用ください。", labelName: "お名前", labelEmail: "メールアドレス", labelMessage: "メッセージ", namePlaceholder: "お名前", emailPlaceholder: "メールアドレス", messagePlaceholder: "メッセージ", sendBtn: "送信", errorText: "すべての項目を正しく入力してください ♡", successText: "送信されました！近日中にご連絡します ♡♡" },
    zh: { contactTitle: "联系", contactDesc: "如果您想通过电子邮件联系我，请使用此表单！", labelName: "姓名", labelEmail: "电子邮件", labelMessage: "消息", namePlaceholder: "姓名", emailPlaceholder: "电子邮件", messagePlaceholder: "消息", sendBtn: "发送", errorText: "请正确填写所有字段 ♡", successText: "消息已发送！您很快会收到回复！ ♡♡" },
    es: { contactTitle: "CONTACTO", contactDesc: "¡Use este formulario si desea contactarme por correo electrónico!", labelName: "NOMBRE", labelEmail: "CORREO ELECTRÓNICO", labelMessage: "MENSAJE", namePlaceholder: "Nombre", emailPlaceholder: "Correo electrónico", messagePlaceholder: "Mensaje", sendBtn: "ENVIAR", errorText: "Por favor complete todos los campos correctamente ♡", successText: "¡Mensaje enviado con éxito! ¡Pronto tendrá noticias mías! ♡♡" }
  },
  poll: {
    en: { pollTitle: "Vote for Your Favorite Character", pollSubtitle: "Click once — you can change your vote anytime", leaderboardTitle: "Leaderboard", leaderboardTooltip: "Website + Discord votes", discordDisclaimer: "Join discord for an extra vote!!" },
    ja: { pollTitle: "お気に入りのキャラクターに投票", pollSubtitle: "一度クリック — いつでも投票を変更できます", leaderboardTitle: "リーダーボード", leaderboardTooltip: "ウェブサイト + Discord 投票", discordDisclaimer: "追加投票のためにDiscordに参加!!" },
    zh: { pollTitle: "为你最喜欢的角色投票", pollSubtitle: "点击一次 — 随时可以更改投票", leaderboardTitle: "排行榜", leaderboardTooltip: "网站 + Discord 投票", discordDisclaimer: "加入Discord获得额外一票!!" },
    es: { pollTitle: "Vota por tu personaje favorito", pollSubtitle: "Haz clic una vez — puedes cambiar tu voto cuando quieras", leaderboardTitle: "Tabla de clasificación", leaderboardTooltip: "Votos del sitio web + Discord", discordDisclaimer: "¡Únete al Discord para un voto extra!!" }
  },
  // ----- HEADER TRANSLATIONS -----
  header: {
    en: {
