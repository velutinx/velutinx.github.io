(function () {
  ...
  /* ==================== PRICE & CURRENCY ==================== */
  // Initial window prices to be overwritten by Worker
  ...
  function addOrToggleCart(pack) {
    ...
    if (index !== -1) {
      ...
      const finalPrice = pack.priceValue !== undefined ? pack.priceValue : getPriceForPack(pack);
  ...
  function updateCartDisplay() {
    ...
    if (window.initPayPalButtons) {
      setTimeout(() => { window.initPayPalButtons(); }, 50);
    }
  }
    ...
    paypal.Buttons({
      ...
      onApprove: async (data, actions) => {
        try {
          ...
          console.error(err);
          alert('Payment successful but finalization failed.');
        }
      },
    ...
    const sidebarHTML = `
      ...
      <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
          <a href="https://velutinx.com/" class="menu-item"><span>HOME</span></a>
          <a href="https://velutinx.com/commission" class="menu-item"><span>COMMISSIONS</span></a>
          <a href="https://velutinx.com/artwork" class="menu-item"><span>ARTWORK</span></a>
          <a href="https://velutinx.com/poll" class="menu-item"><span>POLL</span></a>
          <a href="https://velutinx.com/store" class="menu-item"><span>STORE</span></a>
          <a href="https://velutinx.com/contact" class="menu-item"><span>CONTACT</span></a>
        </div>
        <div class="sidebar-footer"><p>© VELUTINX</p></div>
      </aside>
    `;
