...
const translations = {
  ...
  commissions: {
    en: {
      ...
      perkGold1: "Includes everything from Bronze & Silver tiers, plus:",
      perkGold2: "Your custom request is prioritized over all active custom requests from lower-tier members.",
      badgeArchive: "Archive Access",
      badge1Request: "1 Request",
      badgePriority: "Priority Queue",
    ...
    ja: {
      ...
      perkGold1: "ブロンズとシルバーの全特典に加え：",
      perkGold2: "カスタムリクエストは、下位ティアのアクティブなリクエストよりも優先的に処理されます。",
    ...
    zh: {
      ...
      perkGold1: "包含青铜与白银所有权益，外加：",
      perkGold2: "您的定制请求将优先于所有低等级的活跃定制请求处理。",
      badgeArchive: "档案访问",
      badge1Request: "1次请求",
      badgePriority: "优先队列",
      queueLabel: "📋 当前队列状态",
    ...
    es: {
      ...
      perkGold1: "Incluye todo lo de Bronce y Plata, más:",
      perkGold2: "Tu solicitud personalizada se prioriza sobre todas las solicitudes activas de miembros de niveles inferiores.",
      badgeArchive: "Acceso al Archivo",
      badge1Request: "1 Solicitud",
      badgePriority: "Cola Prioritaria",
