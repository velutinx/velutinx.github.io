...
<nav class="top-nav">
  <div class="nav-left">
<button class="menu-toggle" id="menuToggle" data-cursor-expand aria-label="Menu">
...
<button class="nav-icon" id="themeBtn" data-cursor-expand>
...
<button class="nav-icon" id="cartBtn" data-cursor-expand>
...
<button class="floating-cart" id="floatingCartBtn" data-cursor-expand>
