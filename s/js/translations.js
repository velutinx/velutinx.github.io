...
window.translations = {
  en: {
    ...
    // Gold perks (2) — Bronze + Silver + priority queue
    perk4_1: "Includes everything from Bronze & Silver tiers, plus:",
    perk4_2: "Your custom request is prioritized over all active custom requests from lower-tier members.",
  ...
  ja: {
    ...
    perk4_1: "ブロンズとシルバーの全特典に加え：",
    perk4_2: "カスタムリクエストは、下位ティアのアクティブなリクエストよりも優先的に処理されます。",
  ...
  zh: {
    ...
    perk4_1: "包含青铜与白银所有权益，外加：",
    perk4_2: "您的定制请求将优先于所有低等级的活跃定制请求处理。",
  ...
  es: {
    ...
    perk4_1: "Incluye todo lo de Bronce y Plata, más:",
    perk4_2: "Tu solicitud personalizada se prioriza sobre todas las solicitudes activas de miembros de niveles inferiores.",
